...
export const generateEmailBody(product: EmailProductInfo, type: NotificationType) => {
    ...
    const shortenTitle = product.title.length > 20 ? `${product.title.substring(0, 20)}...` : product.title;
    ...
    switch (type) {
        case Notification.WELCOME:
            subject = `Welcome to Price Tracking for ${shortenTitle}`;
            body = `
        <div>
      ...
      `;
        ...
        case Notification.LOWEST_PRICE:
            subject = `Lowest Price Alert for ${shortenTitle}`;
            body = `
        <div>
      ...
      `;
        ...
        case Notification.THRESHOLD_MET:
            subject = `Discount Alert for ${shortenTitle}`;
            body = `
        <div>
